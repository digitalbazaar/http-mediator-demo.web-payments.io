...
config.views.vars.payments.registerPaymentAppUrl =
  'http://payment-app-demo.web-payments.dev:53080/apps';
config.views.vars.payments.targetPurchaseUrl =
  'http://merchant-demo.web-payments.dev:55080/movies/dr-strangelove';
config.views.vars.payments.paymentRequestUrl =
  'http://merchant-demo.web-payments.dev:55080/movies/dr-strangelove/requests';
